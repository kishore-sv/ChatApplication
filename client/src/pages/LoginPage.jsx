            ...
            <div className=" h-[65vh] w-[90vw] lg:w-[31vw]  rounded-2xl flex flex-col p-5 lg:p-10 border-1 m-auto border-zinc-600  ">
                ...
                <form onSubmit={HandleSumbit}>
                    <div className="flex flex-col mt-7">
                        ...
                        <input type="text" value={userName} onChange={(e) => { setUserName(e.target.value) }} placeholder="Enter Your UserName" className="p-2 mx-2 m-2 outline-zinc-600 border-1 border-zinc-500 rounded-xl" required />
                    </div>
                    <div className="flex flex-col mt-3">
                        <label className="font-semibold" >Password</label>
                        <input type="password" value={password} onChange={(e) => { setPassword(e.target.value) }} placeholder="Enter Your Password" className="p-2 mx-2 m-2 outline-zinc-600 border-1 border-zinc-500 rounded-xl" required />
                    </div>
                    <button
                        type="sumbit"
