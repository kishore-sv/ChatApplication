      ...
      <div className="h-[85vh] lg:h-[86vh] w-[95vw] lg:w-[34vw] rounded-2xl flex flex-col p-10 border-1 m-auto border-zinc-600 ">
        ...
        <form onSubmit={HandleSumbit} >
          ...
          <div className="flex flex-col mt-3">
            ...
            <input disabled={isLoading} type="text" value={userName} onChange={(e) => { setUserName(e.target.value) }} placeholder="UserName"
              className="p-2 mx-2 m-2 outline-zinc-600 border-1 border-zinc-500 rounded-xl"
              required />
          </div>
          <div className="flex flex-col mt-3">
            <label className="font-semibold">Password</label>
            <input disabled={isLoading} type='password' value={password} onChange={(e) => { setPassword(e.target.value) }} placeholder="Password"
              className="p-2 mx-2 m-2 outline-zinc-600 border-1 border-zinc-500 rounded-xl"
              required />
          </div>
          ...
          <button
            ...
            {isLoading ? <img src={loader} className="max-h-4 max-w-4 mx-auto shrink-0 animate-spin" alt="loader" /> : "Create Account"}
          </button>
        </form>
